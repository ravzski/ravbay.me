...
Rails.application.config.assets.paths << "#{Rails.root}/admin/src"
Rails.application.config.assets.paths << "#{Rails.root}/admin/images"
Rails.application.config.assets.paths << "#{Rails.root}/admin/stylesheets"
Rails.application.config.assets.paths << "#{Rails.root}/admin/bower_components"
